...
--
-- Host: localhost    Database: parqueousc
-- ------------------------------------------------------
...
CREATE TABLE `reserva` (
  ...
  `idparqueo` int DEFAULT NULL,
  `horaInicio` float DEFAULT NULL,
  `horaFin` float DEFAULT NULL,
  PRIMARY KEY (`idreserva`),
  KEY `idusuario_idx` (`iduser`),
  KEY `idparqueadero_idx` (`idparqueo`),
  CONSTRAINT `idparqueadero` FOREIGN KEY (`idparqueo`) REFERENCES `parqueadero` (`idparqueo`),
  CONSTRAINT `idusuario` FOREIGN KEY (`iduser`) REFERENCES `usuario` (`iduser`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `usuario` (
  ...
  `estamento` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`iduser`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-03-21 11:21:44
